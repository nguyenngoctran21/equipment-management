                ...
                ?>
                  <tr>
                    ...
                    <td class="nut giua">
                      <?php if ($row['LoaiNV']=='1') {
                      ?>
                      <a class="btn btn-primary" data-l="1" data-qltv="<?php echo $row['Id']; ?>" title="Admin">Admin</a>
                      <?php
                      } else { ?>
                      <a class="btn btn-success" data-l="0" data-qltv="<?php echo $row['Id']; ?>" title="Nhân viên">Nhân viên</i></a>
                      <?php } ?>
                    </td>
