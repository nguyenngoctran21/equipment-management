    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12 col-ms-12">
          <a id="themdocgia" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i> Thêm Người Dùng</a>
        </div>
            ...
            <thead>
                <tr role="row">
                  <tr style="background-color: #2980b9;color: #fff;">
                    ...
                    <th class="giua">Mã Người Dùng</th>
                    ...
                    <th class="giua">Phòng Ban</th>
                    <th class="giua">Bưu Cục</th>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Mã Số Người Dùng</label>
              <input type="text" class="form-control" name="" id="ma-dg-them" placeholder="mã người dùng" required autocomplete="on">
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Họ & Tên</label>
              <input type="text" class="form-control" name="" id="ho-ten-dg-them" placeholder="họ tên người dùng" required autocomplete="on">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <p class="help-block"> (<b>*</b>) Nên dùng địa chỉ mail Bưu Cục cung cấp.</p>
          </div>  
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="" id="ngay-sinh-dg-them" placeholder="họ tên người dùng" required autocomplete="on">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="nut-them-dg">Thêm Người Dùng</button>
      </div>
    </div>
  </div>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="" id="ma-dg-sua" placeholder="mã người dùng" required autocomplete="on">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Họ tên</label>
              <input type="text" class="form-control" name="" id="ho-ten-dg-sua" placeholder="họ tên người dùng" required autocomplete="on" disabled="disabled">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Ngày sinh</label>
              <input type="date" class="form-control" name="" id="ngay-sinh-dg-sua" placeholder="họ tên người dùng" required autocomplete="on" disabled="disabled">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
...
<div class="modal fade in" id="qltv-modal-xoa-dg" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-danger" role="alert">Bạn có chắc muốn xóa người dùng này?</div>
      </div>
