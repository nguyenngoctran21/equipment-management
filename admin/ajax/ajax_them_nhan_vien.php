<?php 
	...
	function vlu_them_nhanvien($ma, $ten, $tdn, $mail,$diachi,$loai,$hspc){
		if (empty($ma)) {
	...
	if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
		if(!qltv_login_tt($_SESSION['username'],$_SESSION['password'])){
			...
			if (vlu_them_nhanvien($_POST['ma'],$_POST['ten'],$_POST['tdn'],$_POST['mail'],$_POST['diachi'],$_POST['loai'],$_POST['hspc'])) {
