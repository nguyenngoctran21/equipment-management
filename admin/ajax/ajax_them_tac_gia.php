<?php 
	...
	function qltv_them_tg($ten, $diachi, $mota){
		if (empty($ten)) {
			echo "<script type=\"text/javascript\">khongthanhcong(\"<strong>Chưa lưu</strong> tên nhà xuất bản không để trống!\")</script>";
			exit();
		}
		if (empty($diachi)) {
			echo "<script type=\"text/javascript\">khongthanhcong(\"<strong>Chưa lưu</strong> địa chỉ nhà xuất bản không để trống!\")</script>";
			exit();
		}
		if (empty($mota)) {
			echo "<script type=\"text/javascript\">khongthanhcong(\"<strong>Chưa lưu</strong> mô tả nhà xuất bản không để trống!\")</script>";
			exit();
		}
